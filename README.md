# UniCreds - Academic Certificate Verification and Documentation System based on Blockchain Technology and Decentralized Storage
...
```text
project-root/
├── backend/              # Smart contract, deployment scripts, and tests
...
```text
backend/contracts/University.sol
```
...
```text
backend/artifacts/contracts/University.sol/University.json
```
